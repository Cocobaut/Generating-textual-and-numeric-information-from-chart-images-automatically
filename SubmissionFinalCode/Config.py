...
Output_Json_Task_2_2 = "E:/Hcmut material/Project_1/SubmissionFinalCode/DatasetPredict/Task2_output"                # Đường dẫn ra output json task 2
...
Task2Config = {
    ...
    "output": Output_Json_Task_2_2
}

Task3Config = {
    "model_path": model_path_layoutlmv3, 
    "data_dir_images": Dataset_Image,
    "data_dir_json": Output_Json_Task_2_2,
